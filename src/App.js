...
class App extends React.Component {
  ...
  addProperty(newProperty) {
    ...
    const activeUserProperties = this.state.activeUserProperties.concat(newProperty);

    this.setState({ allProperties, activeUserProperties });
  }

  render() {

    const { activeUser, allUsers, activeUserStocks, activeUserProperties } = this.state;
    ...
    return (
      <Switch>
        ...
        <Route path="/realestate">
          <RealEstate properties={activeUserProperties} activeUser={activeUser} handleLogout={this.handleLogout} addProperty={this.addProperty} />
        </Route>
